...
export const createTask = async (req, res) => {
  ...
  try {
    const { title, description, priority, dueData, completed } = req.body; // request body se fields nikal rahe hain
    const task = new Task({
      ...
      dueData, // due date set kar rahe hain (note: dueData typo ho sakta hai)
